{
  "version": "1.2",
  "package": {
    "name": "Unibus-access-16-bits",
    "version": "0.1",
    "description": "Unibus-access-16-bits: Access to a 16-bit unidirectional bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ba98e843-5b0f-4683-8ba7-2a02a66e0247",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "cd28056b-0901-422e-8e57-cee39139beb9",
        ...
        {
          "id": "a74b845a-ccba-4dff-9481-75735391882d",
        ...
        {
          "id": "fe5108c0-2c55-4a39-bd64-30ab71b78e1d",
          "type": "basic.input",
          "data": {
            "name": "bus",
            "virtual": true,
        ...
        {
          "id": "2aacdada-ef57-4f0a-b541-81b43c52ec79",
          "type": "basic.outputLabel",
          "data": {
            "name": "dat",
            "range": "[15:0]",
        ...
        {
          "id": "63edbc8d-1db3-4647-b83f-e0c179517b2c",
          "type": "basic.inputLabel",
          "data": {
            "name": "dat",
            "range": "[15:0]",
        ...
        {
          "id": "80eb12aa-8004-4191-b1cc-6b50e7cbf1e0",
          "type": "basic.input",
          "data": {
            "name": "dat",
            "virtual": true,
        ...
        {
          "id": "b50df6bb-b45e-40d5-8fa0-0965fe9350ff",
          "type": "basic.inputLabel",
          "data": {
            "name": "bus_o",
            "range": "[15:0]",
        ...
        {
          "id": "1fb859a7-ce7e-4f3b-aaaf-60b3d348c3dd",
          "type": "basic.outputLabel",
          "data": {
            "name": "bus_i",
            "range": "[15:0]",
        ...
        {
          "id": "261ec6a8-e603-424e-9cce-8c593af664d5",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "261ec6a8-e603-424e-9cce-8c593af664d5",
        ...
        {
          "source": {
            "block": "cd28056b-0901-422e-8e57-cee39139beb9",
            "port": "outlabel"
          },
          "target": {
            "block": "ba98e843-5b0f-4683-8ba7-2a02a66e0247",
            "port": "in",
            "size": 16
          },
          "size": 16
        ...
        {
          "source": {
            "block": "fe5108c0-2c55-4a39-bd64-30ab71b78e1d",
            "port": "out",
            "size": 16
          },
          "target": {
            "block": "a74b845a-ccba-4dff-9481-75735391882d",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          "source": {
            "block": "80eb12aa-8004-4191-b1cc-6b50e7cbf1e0",
            "port": "out",
            "size": 16
          },
          "target": {
            "block": "63edbc8d-1db3-4647-b83f-e0c179517b2c",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          ...
          "target": {
            "block": "b50df6bb-b45e-40d5-8fa0-0965fe9350ff",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          "source": {
            "block": "1fb859a7-ce7e-4f3b-aaaf-60b3d348c3dd",
            "port": "outlabel"
          },
          "target": {
            "block": "261ec6a8-e603-424e-9cce-8c593af664d5",
        ...
        {
          "source": {
            "block": "2aacdada-ef57-4f0a-b541-81b43c52ec79",
            "port": "outlabel"
          },
          "target": {
            "block": "261ec6a8-e603-424e-9cce-8c593af664d5",
