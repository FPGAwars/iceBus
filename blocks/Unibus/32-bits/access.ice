{
  "version": "1.2",
  "package": {
    "name": "Unibus-access-32-bits",
    "version": "0.1",
    "description": "Unibus-access-32-bits: Access to a 32-bit unidirectional bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7d7d164e-301f-4261-9919-12ae933547af",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "a43e37b8-9932-47ee-aaef-be98ab172798",
        ...
        {
          "id": "1181a244-e6b4-4227-b384-63c86de19c0f",
        ...
        {
          "id": "2f2f0e05-e96d-43a8-95fd-30063b7b6819",
          "type": "basic.input",
          "data": {
            "name": "bus",
            "virtual": true,
        ...
        {
          "id": "02500e6e-6ec0-412e-8c04-3306d38ed3ea",
          "type": "basic.outputLabel",
          "data": {
            "name": "dat",
            "range": "[31:0]",
        ...
        {
          "id": "21862095-d875-4094-b080-6ce06511ee0b",
          "type": "basic.input",
          "data": {
            "name": "dat",
            "virtual": true,
        ...
        {
          "id": "c0cb1fcc-8b5c-48d7-ba30-b135b20aa2e5",
          "type": "basic.inputLabel",
          "data": {
            "name": "dat",
            "range": "[31:0]",
        ...
        {
          "id": "d707a466-6ffd-4ba9-aab1-54dfd0a02d61",
          "type": "basic.outputLabel",
          "data": {
            "name": "bus_i",
            "range": "[31:0]",
        ...
        {
          "id": "aa3b2ab7-69be-41a6-99d8-91622b718ed2",
          "type": "basic.inputLabel",
          "data": {
            "name": "bus_o",
            "range": "[31:0]",
        ...
        {
          "id": "39eb2a5a-43c1-493c-9891-9688ff039698",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "39eb2a5a-43c1-493c-9891-9688ff039698",
        ...
        {
          "source": {
            "block": "a43e37b8-9932-47ee-aaef-be98ab172798",
            "port": "outlabel"
          },
          "target": {
            "block": "7d7d164e-301f-4261-9919-12ae933547af",
            "port": "in",
            "size": 32
          },
          "size": 32
        ...
        {
          "source": {
            "block": "2f2f0e05-e96d-43a8-95fd-30063b7b6819",
            "port": "out",
            "size": 32
          },
          "target": {
            "block": "1181a244-e6b4-4227-b384-63c86de19c0f",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "21862095-d875-4094-b080-6ce06511ee0b",
            "port": "out",
            "size": 32
          },
          "target": {
            "block": "c0cb1fcc-8b5c-48d7-ba30-b135b20aa2e5",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "aa3b2ab7-69be-41a6-99d8-91622b718ed2",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "d707a466-6ffd-4ba9-aab1-54dfd0a02d61",
            "port": "outlabel"
          },
          "target": {
            "block": "39eb2a5a-43c1-493c-9891-9688ff039698",
        ...
        {
          "source": {
            "block": "02500e6e-6ec0-412e-8c04-3306d38ed3ea",
            "port": "outlabel"
          },
          "target": {
            "block": "39eb2a5a-43c1-493c-9891-9688ff039698",
