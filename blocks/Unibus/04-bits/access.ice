{
  "version": "1.2",
  "package": {
    "name": "Unibus-access-4-bits",
    "version": "0.1",
    "description": "Unibus-access-4-bits: Access to a 4-bit unidirectional bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "caf8b492-afc6-454d-b562-9281f0f35a61",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "cf0042c7-9cdd-4aee-bbe8-a2bd5bf7d719",
        ...
        {
          "id": "61064ccc-6621-4523-9ee6-4d9e906f7084",
          "type": "basic.input",
          "data": {
            "name": "bus",
            "virtual": true,
        ...
        {
          "id": "4dcf37c5-2b9e-41fb-9aa9-e153a8e14655",
        ...
        {
          "id": "80489408-181c-4d20-b4f0-85b9ee2c0c94",
          "type": "basic.outputLabel",
          "data": {
            "name": "dat",
            "range": "[3:0]",
        ...
        {
          "id": "efed50dd-617b-4964-afaa-75fea0533f59",
          "type": "basic.input",
          "data": {
            "name": "dat",
            "virtual": true,
        ...
        {
          "id": "a8b1b7b2-3179-4fef-8602-a62569abc364",
          "type": "basic.inputLabel",
          "data": {
            "name": "dat",
            "range": "[3:0]",
        ...
        {
          "id": "cfc03fe8-a141-4c63-8787-0591b49169a6",
          "type": "basic.outputLabel",
          "data": {
            "name": "bus_i",
            "range": "[3:0]",
        ...
        {
          "id": "89481993-72f4-44cc-8a80-eade9e59e2c3",
          "type": "basic.inputLabel",
          "data": {
            "name": "bus_o",
            "range": "[3:0]",
        ...
        {
          "id": "4b56495e-9ff4-4ec5-bd23-c5058d852882",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "4b56495e-9ff4-4ec5-bd23-c5058d852882",
        ...
        {
          "source": {
            "block": "cf0042c7-9cdd-4aee-bbe8-a2bd5bf7d719",
            "port": "outlabel"
          },
          "target": {
            "block": "caf8b492-afc6-454d-b562-9281f0f35a61",
            "port": "in",
            "size": 4
          },
          "size": 4
        ...
        {
          "source": {
            "block": "61064ccc-6621-4523-9ee6-4d9e906f7084",
            "port": "out",
            "size": 4
          },
          "target": {
            "block": "4dcf37c5-2b9e-41fb-9aa9-e153a8e14655",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "efed50dd-617b-4964-afaa-75fea0533f59",
            "port": "out",
            "size": 4
          },
          "target": {
            "block": "a8b1b7b2-3179-4fef-8602-a62569abc364",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "89481993-72f4-44cc-8a80-eade9e59e2c3",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "80489408-181c-4d20-b4f0-85b9ee2c0c94",
            "port": "outlabel"
          },
          "target": {
            "block": "4b56495e-9ff4-4ec5-bd23-c5058d852882",
        ...
        {
          "source": {
            "block": "cfc03fe8-a141-4c63-8787-0591b49169a6",
            "port": "outlabel"
          },
          "target": {
            "block": "4b56495e-9ff4-4ec5-bd23-c5058d852882",
